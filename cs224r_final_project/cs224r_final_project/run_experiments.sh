# this is to store the commands for our experiments and is NOT an immediately runnable file 
# many of these commands require edits to the pipette_env file before running.
